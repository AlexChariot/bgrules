...
class SearchAgent:
    def run(self, game):
        ...
        from scraper import search, cache_exists
...
class DownloadAgent:
    ...
    def run(self, urls, game=None):
        ...
        from scraper import safe_download, save_to_cache, load_from_cache, detect_language, extract_text_from_pdf, _validate_pdf_content
